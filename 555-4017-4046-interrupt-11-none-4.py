...
INT4 = 4      # define GPIO pin number for interrupt CD4046 (pin4) con GPIO 4 
lastTime = time.time()
dMax1 = 0;
dMin1 = 2;
dSum1 = 0;
...
try:
	while (1):
		...
		print("Time555: %s Avg: %08.6f Min: %08.6f Max: %08.6f Total: %d" % (dstr1, dAvg1, dMin1, dMax1, dCount1))
   		...
   		if (dCount2 > 0):
      			dAvg2 = dSum2 / dCount2
		print("Time4046: %s Avg: %08.6f Min: %08.6f Max: %08.6f Total: %d" % (dstr2, dAvg2, dMin2, dMax2, dCount2))
