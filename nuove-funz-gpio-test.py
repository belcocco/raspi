...
#Prova test GPIO INPUT-OUTPUT-PWM 
...
def test_falling():
    def cb(chan):
        print "Callback called - channel", chan
...
def test_warnings():
    ...
    GPIO.setup(14, GPIO.OUT)   # is ALT0 serial TXD by default
    print "Done!"
    GPIO.setwarnings(True)
    print "Warning should be produced vvv"
    GPIO.setup(15, GPIO.OUT)  # is ALT0 serial RXD by default
    print "Done!"

def test_setup():
    print "Running setup tests..."
    GPIO.setmode(GPIO.BCM)
    GPIO.setup(7, GPIO.OUT, initial=GPIO.HIGH) # or True
    if not GPIO.input(7):
...
while 1:
    ...
    print('2 - Input')
    print('3 - Rising edge')
    print('4 - Falling edge')
    print('5 - Software PWM')
    print('6 - Hardware PWM')
    print('7 - Switchbounce')
    print('8 - gpio_function')
    print('9 - Board revision')
    print('10 - Test warnings')
    print('11 - Version')
    print('12 - eXit')
