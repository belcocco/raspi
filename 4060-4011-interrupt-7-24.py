...
INTfirst = 7      # define GPIO pin number for interrupt 4060 (pin) con GPIO 7
INTsecond = 24      # define GPIO pin number for interrupt CD4011 (pin) con GPIO 24
lastTime = time.time()
dMax1 = 0;
dMin1 = 2;
dSum1 = 0;
...
input_value_11 = RPIO.input(INTfirst)
input_value_4 = RPIO.input(INTsecond)
