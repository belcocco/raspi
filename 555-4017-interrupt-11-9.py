...
INT9 = 9      # define GPIO pin number for interrupt CD4017 (pin12) con GPIO 9
lastTime = time.time()
dMax1 = 0;
dMin1 = 2;
dSum1 = 0;
...
#Definizione della callback per impulsi in uscita da 4017 su pin 12 (collegato a GPIO 9)
...
RPIO.add_interrupt_callback(INT9, gpio_callback_2, edge='rising', pull_up_down=RPIO.PUD_UP)#, debounce_timeout_ms=100)
